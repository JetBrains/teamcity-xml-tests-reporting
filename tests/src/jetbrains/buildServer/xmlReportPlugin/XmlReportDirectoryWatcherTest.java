...
@RunWith(JMock.class)
public class XmlReportDirectoryWatcherTest {
  ...
  private XmlReportPlugin createTestReportParserPlugin() {
    return myContext.mock(XmlReportPlugin.class);
  }
  ...
  public void testLogDirectoryTotalsAfterCreation() {
    ...
    final XmlReportDirectoryWatcher watcher = new XmlReportDirectoryWatcher(createTestReportParserPlugin(), new ArrayList<File>(), "junit", createLinkedBlockingQueue());
