...
public class TestGenerator {
  ...
  public static final long TEST_NUMBER = 100;

  public static void main(String[] args) {
    for (int n = 0; n < TEST_DIR_NUMBER; ++n) {
      for (int i = 0; i < TEST_CASE_NUMBER; ++i) {
        String testCaseName = "TestClass" + i + "_" + n;
        File outFile = new File(/*"jetbrains\\buildServer\\testReportParserPlugin\\visual\\" + */testCaseName + ".java");
        FileWriter out;
        try {
          out = new FileWriter(outFile);

//                    out.write("package jetbrains.buildServer.testReportParserPlugin.visual;\n");
