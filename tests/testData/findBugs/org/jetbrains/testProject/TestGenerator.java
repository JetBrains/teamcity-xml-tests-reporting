...
{
  public static final long TEST_DIR_NUMBER = 1;
  public static final long TEST_CASE_NUMBER = 5;
  public static final long TEST_NUMBER = 50;
  ...
  public static void main(String[] args) {
    ...
    for (int n = 0; n < TEST_DIR_NUMBER; ++n) {
      for (int i = 0; i < TEST_CASE_NUMBER; ++i) {
        ...
        File outFile = new File("out\\production\\TestProject\\com\\swiftteams\\TestProject\\" + testCaseName + ".java");
        FileWriter out;
        try {
          out = new FileWriter(outFile);

          out.write("package com.swiftteams.testProject;\n");
