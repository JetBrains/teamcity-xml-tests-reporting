...
public class XmlReportLogger {
  private static final Logger AGENT_LOG = Logger.getInstance(XmlReportPlugin.class.getName());

  private final BaseServerLoggerFacade myBuildLogger;
  private boolean myVerboseOutput;

  public XmlReportLogger(@NotNull BaseServerLoggerFacade buildLogger, boolean verboseOutput) {
